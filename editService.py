...
class admin_login(unittest.TestCase):
    ...
    def test_blog(self):
        ...
        # xpath, clicks on edit service button
        ...
        elem.clear()
        elem.send_keys("Dinner and Breverages : 50 guests ")
        ...
        elem.clear()
        elem.send_keys("2018-12-25 20:00:00")
        time.sleep(1)



        #xpath, clicks on update button for edit service
